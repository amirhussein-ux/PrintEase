      ...
      <Dialog onClose={onClose} className="relative z-50">
        ...
        <div className="fixed inset-0 overflow-y-auto p-4 sm:p-6 md:p-8">
          <div className="mx-auto max-w-2xl">
            ...
            >
              <DialogPanel className={`${SERVICE_MODAL_PANEL} transition-all duration-150 ease-out hover:scale-[1.01]`}>
                <div className={`${SERVICE_MODAL_HEADER}`}>
                  ...
                  <button 
                    onClick={onClose} 
                    className="p-2 rounded-xl text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-all duration-150 ease-out transform hover:scale-110 hover:rotate-90 dark:text-gray-300 dark:hover:text-white dark:hover:bg-gray-800" 
                    aria-label="Close"
                  >
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                      {imagePreview ? (
                        <div className="mt-1 mx-auto w-36">
                          <div
                            className="flex flex-col items-center justify-center w-36 h-36 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer bg-white/95 hover:bg-white transition-all duration-150 ease-out transform hover:scale-105 dark:border-gray-600 dark:bg-gray-800 dark:hover:bg-gray-700"
                            role="button"
                            onClick={() => setShowCropper(imageOriginalSrc ?? imagePreview)}
                            title="Click to crop"
                          >
                            <div className="h-32 w-32 rounded-lg overflow-hidden bg-white flex items-center justify-center transition-all duration-150 ease-out hover:scale-105 dark:bg-gray-900">
                              <img src={imagePreview} alt="preview" className="h-full w-full object-cover transition-all duration-150 ease-out hover:scale-110" />
                            </div>
                          </div>
                        <div className="mt-3">
                            <button
                              ...
                              className="w-full rounded-xl border px-3 py-2 text-sm text-red-600 bg-red-50/80 hover:bg-red-100 transition-all duration-150 ease-out transform hover:scale-105 dark:border-red-500/40 dark:text-red-200 dark:bg-red-500/10 dark:hover:bg-red-500/20"
                            >
                              Remove image
                            </button>
                          </div>
                        ...
                        >
                          ...
                          <p className="mb-1 text-sm text-gray-600 text-center transition-all duration-150 ease-out hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-200">
                            <span className="font-semibold">Click to upload</span> or drag & drop
                          </p>
                          <p className="text-xs text-gray-500 text-center transition-all duration-150 ease-out hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">PNG, JPG or SVG</p>
                          <input
                            id="serviceImage"
                            type="file"
                            accept="image/*"
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        type="button"
                        onClick={addVariant}
                        className="inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-500 transition-all duration-150 ease-out transform hover:scale-105 dark:text-blue-300 dark:hover:text-blue-200"
                      >
                        <PlusIcon className="h-5 w-5 transition-transform duration-150 hover:rotate-90" /> Add attribute
                      </button>
                    </div>
                    {variants.length === 0 && (
                      <div className="text-sm text-gray-600 p-4 border border-dashed border-gray-300 rounded-xl text-center transition-all duration-150 ease-out hover:scale-[1.02] hover:bg-blue-50/40 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-800/40">
                        Add attributes like Size, Color, Material, etc.
                      </div>
                    )}
                    <div className="space-y-4">
                      {variants.map((v, vIdx) => (
                        <div key={vIdx} className="rounded-xl border border-gray-200 bg-white/90 p-4 transition-all duration-150 ease-out hover:scale-[1.02] hover:border-blue-300 dark:border-gray-600 dark:bg-gray-800/50">
                          <div className="flex items-center gap-3">
                            <input
                              value={v.label}
                            ...
                            <button
                              ...
                              className="p-3 rounded-xl border border-red-200 text-red-600 hover:bg-red-50 transition-all duration-150 ease-out transform hover:scale-110 dark:border-red-500/40 dark:text-red-200 dark:hover:bg-red-500/10"
                          ...
                          <div className="mt-3 space-y-3">
                                        ...
                                        <div className="absolute z-40 mt-1 w-full rounded-xl border border-gray-200 bg-white shadow-2xl max-h-48 overflow-auto backdrop-blur-sm dark:border-gray-600 dark:bg-gray-900">
                                          ...
                                          {filteredSuggestions.map(s => (
                                            <div
                                              ...
                                              className={`px-4 py-3 text-sm cursor-pointer transition-all duration-150 hover:bg-blue-50/80 dark:hover:bg-gray-800 ${s === o.name ? 'bg-blue-50/80 dark:bg-gray-800' : ''}`}
                                            >
                                              {s}
                                            </div>
                                          ))}
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-2 text-sm text-blue-600 hover:text-blue-500 transition-all duration-150 ease-out transform hover:scale-105 dark:text-blue-300 dark:hover:text-blue-200"
                            >
                              <PlusIcon className="h-4 w-4 transition-transform duration-150 hover:rotate-90" /> Add option
                            </button>
                          </div>
                        </div>
                      ))}
                  ...
                  <div className="pt-4 flex justify-end gap-3">
                    <button 
                      type="button" 
                      onClick={onClose} 
                      className="px-6 py-3 rounded-xl border border-gray-600 text-black dark:text-white hover:bg-gray-700/50 transition-all duration-150 ease-out transform hover:scale-105"
                    >
                      Cancel
                    </button>
                    <button 
                      type="submit" 
                      className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 font-semibold transition-all duration-150 ease-out transform hover:scale-105 shadow-lg hover:shadow-blue-500/25"
                    >
